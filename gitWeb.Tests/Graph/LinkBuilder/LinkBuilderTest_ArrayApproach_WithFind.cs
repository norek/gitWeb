...
{
    public class LinkBuilderTest_ArrayApproach_WithFind
    {
        ...
        public void WhenCommitHasOneParent_BuilderShouldLinkedHimWithOneLine()
        {
            ...
            var links = _linkBuilder.BuildNoOptimalizedLinqOnArrayFind(new[] { commit, parentCommit });
        ...
        public void WhenTwoCommitsHasSameParent_BuilderShouldCreateOneLinkPerRelation()
        {
            ...
            var links = _linkBuilder.BuildNoOptimalizedLinqOnArrayFind(new[] { commit1, commit2, parentCommit });
