...
{
    public class LinkBuilderTest_ArrayApproach_withLinq
    {
        ...
        public void WhenCommitHasOneParent_BuilderShouldLinkedHimWithOneLine()
        {
            ...
            var links = _linkBuilder.Build_On_Array_WithLinq(new[] { commit, parentCommit });
        ...
        public void WhenTwoCommitsHasSameParent_BuilderShouldCreateOneLinkPerRelation()
        {
            ...
            var links = _linkBuilder.Build_On_Array_WithLinq(new[] { commit1, commit2, parentCommit });
