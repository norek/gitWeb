...
{
    public class LinkBuilderTest_ArrayApproach_WithForLoops
    {
        ...
        public void WhenCommitHasOneParent_BuilderShouldLinkedHimWithOneLine()
        {
            ...
            var links = _linkBuilder.BuildOnArray_ForLoop(new[] { commit, parentCommit });
        ...
        public void WhenTwoCommitsHasSameParent_BuilderShouldCreateOneLinkPerRelation()
        {
            ...
            var links = _linkBuilder.BuildOnArray_ForLoop(new[] { commit1, commit2, parentCommit });
