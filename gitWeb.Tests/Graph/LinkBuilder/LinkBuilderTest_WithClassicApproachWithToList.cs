...
{
    public class LinkBuilderTest_WithClassicApproachWithToList
    {
        ...
        public void WhenCommitHasOneParent_BuilderShouldLinkedHimWithOneLine()
        {
            ...
            var links = _linkBuilder.Build_ClassicApproach_WithToList(new List<Commit>(){ commit, parentCommit });
        ...
        public void WhenCommitHasMoreThanOneParent_CreateLinksNumberOfLinksEqualsToNumberOfParents()
        {
            ...
            var links = _linkBuilder.Build_ClassicApproach_WithToList(new List<Commit>() { commit, parentCommit, parentCommit1, parentCommit2 });
        ...
        public void WhenTwoCommitsHasSameParent_BuilderShouldCreateOneLinkPerRelation()
        {
            ...
            var links = _linkBuilder.Build_ClassicApproach_WithToList(new List<Commit>() { commit1, commit2, parentCommit});
